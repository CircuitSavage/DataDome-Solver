...
// Profile holds static browser fingerprint values.
...
var chromeWin10 = Profile{
	...
	"rs_w":  1920, "rs_h": 1080, "rs_cd": 24,
	"ars_w": 1920, "ars_h": 1040,
	"br_oh": 1040, "br_ow": 1920,
	"br_w":  1920, "br_h": 929, "br_iw": 1920, "br_ih": 929,
	"pr": 1, "cg_w": 1920, "cg_h": 0, "sg_w": 0, "sg_h": 48,
	"so": "landscape-primary",
	"plu": "PDF Viewer,Chrome PDF Viewer,Chromium PDF Viewer,Microsoft Edge PDF Viewer,WebKit built-in PDF",
	"plg": 5, "plgne": true, "plgre": true, "plgof": false, "plggt": false, "plgod": false,
...
var chromeWin10DE = func() Profile {
	...
	p["br_w"], p["br_h"], p["br_iw"], p["br_ih"] = 849, 1305, 849, 1305
	return p
}()

// Profiles maps profile names to defaults.
